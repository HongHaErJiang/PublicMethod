...
@property(nonatomic, assign)CGSize size; //自身高度
...
- (void)textViewDidEndEditing:(NSNotification *)notification{
    ...
    if ([super text].length == 0) {
        ...
        [super setTextColor: [UIColor colorWithRed:204/255.0 green:204/255.0 blue:204/255.0 alpha:1]];
    }
}
...
- (void)textViewDidChange:(NSNotification *)notification{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:TEXTVIEWHEIGHT object:@(self.size.height)];
}
